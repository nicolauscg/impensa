...
scp ./.env ./impensa_be_api_secret.txt ./impensa_be_mgoconnstring.txt ./impensa_be_mailgun_api.txt ./impensa_be_google_oauth_client_id.txt ./impensa_be_google_oauth_client_secret.txt $HOST:~/
